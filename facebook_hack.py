...
versionPath = os.path.join("core", "version.txt")
                                                                                                                                                                                 ...
                                                                                                                                                                                 try:import requests
except ImportError:                                                                                                                                                                  errMsg("[ requests ] module is missing")
...
def Main():
   ...
   faceboom = FaceBoom()
   target = options.target                                                                                                                                                          wordlist = options.wordlist
   ...
   if update:
    ...
    sys.exit(1)
        ...
        sys.exit(1)
   elif wordlist or single_passwd:                                                                                                                                                       if wordlist:
            if not os.path.isfile(wordlist):                                                                                                                                                     errMsg("Please check Your Wordlist Path")
                sys.exit(1)                                                                                                                                                              if single_passwd:
